...
static void *sha256_init(void)
{
    ...
    s = (SHA256_State *)malloc(sizeof(SHA256_State));
    SHA256_Init(s);
    return s;
}
...
{
    return (SHA256_State *)malloc(3 * sizeof(SHA256_State));
}
...
static void hmacsha256_bytes(void *handle, unsigned char *blk, int len)
{
    SHA256_State *keys = (SHA256_State *)handle;
...
static int hmacsha256_verresult(void *handle, unsigned char *hmac)
{
