...
**Description: The source file of class StackTrace.
*/
...
void DumpStackTraceToStrings(void* const* stacktrace,
                             int count,
...
int StackTrace::ToString(std::string* stack) const
{
    std::stringstream ss;
    int size = Output(&ss);
    *stack = ss.str();
...
int StackTrace::Output(std::ostream* os) const
{
    std::vector<std::string> stacks;
    DumpStackTraceToStrings(mTrace, mCount, &stacks);
